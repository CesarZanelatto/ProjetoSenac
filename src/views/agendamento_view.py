...
class AgendamentoView(View):
    ...
    def add_agendamento(self):
        ...
        self.agendamento_dao.add_agendamento(
            novo_agendamento
        )

        self.tabela_agendamentos.rows = (
            self.build_rows_agendamentos()
        )
    ...
    def selecionar_dia(self, e):
        ...
        self.texto_consultas_dia.value = (
            f"Consultas do Dia {self.dia_selecionado}"
        )
        ...
        self.calendario_container.content = (
            self.build_calendario_container()
        )
    ...
    def deletar_agendamento(self, e):
        ...
        self.agendamento_dao.deletar_agendamento(
            agendamento["id"]
        )
